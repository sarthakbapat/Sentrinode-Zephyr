...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_BLUENRG_ACI, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_SPI, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_SPI_INIT_PRIORITY, 75);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_SPI_BOOT_TIMEOUT_SEC, 30);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_SPI_BLUENRG, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_HCI_TX_STACK_SIZE, 416);
